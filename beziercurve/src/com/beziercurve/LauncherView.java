...
//        Log.e("redPath1",mWidth / 5 - mWidth / 2+"==");
        ...
        //Log.e("redPath2",-700+"=="+-mHeight / 2+"==="+ mWidth / 3 * 2+"==="+ -mHeight / 3 * 2+"==="+0+"==="+-dp80+"==");

        ViewPath purplePath1 = new ViewPath(); 
        purplePath1.moveTo(0, 0);
        purplePath1.lineTo(mWidth / 5 * 2 - mWidth / 2, 0);
        ViewPath purplePath2 = new ViewPath(); 
	...
	private void addAnimation(ObjectAnimator animator1, ObjectAnimator animator2, ImageView target) {
        ...
        all.addListener(new AnimAllEndListener());
        all.start();
    }
    ...
    private class AnimAllEndListener extends AnimatorListenerAdapter{
    	@Override
